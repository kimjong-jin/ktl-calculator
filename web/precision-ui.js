...
function renderGraphsInModal(code) {
  ...
  const labelMap = {
    ...
    m1: 'M1', m2: 'M2', m3: 'M3',
    ph7a: '반 pH7-1', ph4a: '반 pH4-1', ph7b: '반 pH7-2', ph4b: '반 pH4-2', ph7c: '반 pH7-3', ph4c: '반 pH4-3',
...
function buildFormBasic(code) {
  ...
  <div class="pv-section" style="border-left:3px solid var(--warn)">
    <p style="margin:0;line-height:1.8"><mark style="background:#fde047;color:#1f2328;padding:2px 6px;border-radius:3px;font-size:13px;font-weight:700;box-decoration-break:clone;-webkit-box-decoration-break:clone">⏱️ TOC: 드리프트 1차 측정 후 최소 4시간 경과 뒤 2차 측정 · 기본 16회 측정 · Z3, Z4까지 측정 시 총 18회 측정</mark></p>
  </div>
