...
export const ITEM_MAP = {
  TU: {
    ...
    기기명: '탁도 연속자동측정기',
    정도검사주기: '2년',
    기준값: { 반복성: '측정범위의 2.0% 이하', 제로드리프트: '측정범위의 3.0% 이하', 스팬드리프트: '측정범위의 3.0% 이하', 직선성: '주입농도값의 ±5.0% 이하', 응답시간: '10분(90%) 이하' },
    법령: [
  ...
  CL: {
    ...
    기기명: '잔류염소 연속자동측정기',
    정도검사주기: '2년',
    기준값: { 반복성: '측정범위의 2.0% 이하', 제로드리프트: '측정범위의 3.0% 이하', 스팬드리프트: '측정범위의 3.0% 이하', 직선성: '주입농도값의 ±5.0% 이하', 응답시간: '2분(90%) 이하' },
    법령: [
      { type: 'admrul', ref: '2100000269484', name: '환경측정기기의 형식승인·정도검사 등에 관한 고시',    기관: '국립환경과학원' },
      { type: 'law',    ref: '276829',        name: '환경분야 시험·검사 등에 관한 법률',                기관: '환경부' },
      { type: 'law',    ref: '284921',        name: '환경분야 시험·검사 등에 관한 법률 시행령',          기관: '환경부' },
  ...
  TOC: {
    ...
    분야: '수질TMS',
    기기명: '총유기탄소 연속자동측정기',
    정도검사주기: '2년 (최초 2회) / 이후 1년',
    기준값: { 반복성: '측정범위의 3.0% 이하', 제로드리프트: '측정범위의 5.0% 이하', 스팬드리프트: '측정범위의 5.0% 이하', 직선성: '주입농도값의 ±5.0% 이하', 응답시간: '15분(90%) 이하', 현장적용계수: '15.0% 이하' },
    법령: [
      { type: 'admrul', ref: '2100000269484', name: '환경측정기기의 형식승인·정도검사 등에 관한 고시',    기관: '국립환경과학원' },
      { type: 'law',    ref: '276829',        name: '환경분야 시험·검사 등에 관한 법률',                기관: '환경부' },
      { type: 'law',    ref: '284921',        name: '환경분야 시험·검사 등에 관한 법률 시행령',          기관: '환경부' },
  ...
  TN: {
    ...
    기기명: '총질소 연속자동측정기',
    정도검사주기: '2년 (최초 2회) / 이후 1년',
    기준값: { 반복성: '측정범위의 3.0% 이하', 제로드리프트: '측정범위의 5.0% 이하', 스팬드리프트: '측정범위의 5.0% 이하', 직선성: '주입농도값의 ±5.0% 이하', 현장적용계수: '15.0% 이하' },
    법령: [
      { type: 'admrul', ref: '2100000269484', name: '환경측정기기의 형식승인·정도검사 등에 관한 고시',    기관: '국립환경과학원' },
      { type: 'law',    ref: '276829',        name: '환경분야 시험·검사 등에 관한 법률',                기관: '환경부' },
      { type: 'law',    ref: '284921',        name: '환경분야 시험·검사 등에 관한 법률 시행령',          기관: '환경부' },
  ...
  DO: {
    ...
    기기명: '용존산소 연속자동측정기',
    정도검사주기: '2년 (최초 2회) / 이후 1년',
    기준값: { 응답시간: '2분(90%) 이하', 반복성: '측정범위의 3.0% 이하', 제로드리프트: '측정범위의 5.0% 이하', 스팬드리프트: '측정범위의 5.0% 이하', 직선성: '주입농도값의 ±5.0% 이하', 현장적용계수: '15.0% 이하' },
    법령: [
      { type: 'admrul', ref: '2100000269484', name: '환경측정기기의 형식승인·정도검사 등에 관한 고시',    기관: '국립환경과학원' },
      { type: 'law',    ref: '276829',        name: '환경분야 시험·검사 등에 관한 법률',                기관: '환경부' },
      { type: 'law',    ref: '284921',        name: '환경분야 시험·검사 등에 관한 법률 시행령',          기관: '환경부' },
  ...
  PH: {
    ...
    기기명: 'pH 연속자동측정기',
    정도검사주기: '2년',
    기준값: { 반복성: '측정범위의 3.0% 이하', 제로드리프트: '측정범위의 5.0% 이하', 스팬드리프트: '측정범위의 5.0% 이하', 직선성: '주입농도값의 ±5.0% 이하', 현장적용계수: '20.0% 이하' },
    법령: [
      { type: 'admrul', ref: '2100000269484', name: '환경측정기기의 형식승인·정도검사 등에 관한 고시',    기관: '국립환경과학원' },
      { type: 'law',    ref: '276829',        name: '환경분야 시험·검사 등에 관한 법률',                기관: '환경부' },
      { type: 'law',    ref: '284921',        name: '환경분야 시험·검사 등에 관한 법률 시행령',          기관: '환경부' },
...
export async function getLegalBasis(item) {
  ...
  // law.go.kr 파싱 시도 — 실패 시 하드코딩 기준값 폴백
  let standards = meta.기준값 || null;
  try {
    const primaryLaw = meta.법령[0];
    ...
    const parsed = parseStandards(section);
    if (parsed) standards = parsed;
  } catch { /* 외부 API 실패 → 폴백 사용 */ }
